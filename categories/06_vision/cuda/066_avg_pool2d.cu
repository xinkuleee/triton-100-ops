...
namespace gpu_ops {
__global__ void op066_avg_pool2d_kernel(
...
cudaError_t launch_op066_avg_pool2d(
  ...
  op066_avg_pool2d_kernel<<<ceil_div_int(total, kThreads), kThreads, 0, stream>>>(x, out, total, height, width, out_height, out_width, kernel_height, kernel_width, stride, padding);
